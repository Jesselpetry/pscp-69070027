...
```text
โจทย์ให้ฉันอ่านค่าสี 2 สีแล้วมาดูว่าถ้าผสมกันจะได้สีอะไรตามหลักคู่สี

Input:
โปรแกรมรับค่าสีที่ 1
โปรแกรมรับค่าสีที่ 2

Output:
โปรแกรมแสดงออกค่าสีที่ควรจะผสมกันได้ จาก 2 สีที่แตกต่างกัน
หรือ โปรแกรมแสดงออกค่าสีที่ควรจะผสมกันได้ จาก 2 สีที่เหมือนกัน
หรือ โปรแกรมแสดงออกค่าสีที่ควรจะผสมกันได้ จาก สีที่ไม่ได้อนุญาติ

Constraints:
input: allowed_color = ["Red","Blue","Yellow"] เท่านั้นถึงจะเข้า logic ผสมสี
output: 1 บรรทัด เป็นชื่อสี หรือ Error
```
...
```text
Step 1: รับค่าสีที่ 1
Step 2: รับค่าสีที่ 2
Step 3: เช็คว่าสีทั้ง 2 สามารถผสมได้ไหมจาก allowed_color = ["Red","Blue","Yellow"]
Step 4: เข้า logic การผสมสี และ output ออกมาเป็นสีนั้น ๆ หรือ หากไม่สามารถเข้า logic ได้จะแสดงค่า "Error" ออกมา
```
...
```text
เพราะมีสีที่อนุญาติทั้งหมดและแตกต่างจาก Test 1
```
...
```text
เพราะมีสีที่อนุญาตและไม่อนุญาติและแตกต่างจาก Test 1 & 2
```
