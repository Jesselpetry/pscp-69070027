...
```text
โจทย์ให้หาจำนวนอิฐเล็ก (1 นิ้ว) ที่น้อยที่สุดเพื่อสร้างสะพานให้ยาว goal นิ้ว โดยต้องเลือกใช้อิฐใหญ่ (5 นิ้ว) ให้มากที่สุดก่อน

Input:
3 บรรทัด
จำนวนเต็มบวก 3 จำนวน จำนวนละ 1 บรรทัด
...
Constraints:
ใช้อิฐใหญ่เท่าที่ไม่เกิน goal และไม่เกิน b ที่มี จากนั้นตรวจว่าอิฐเล็ก a มีพอโปะความยาวที่เหลือหรือไม่
...
```text
Step 1: อ่านค่า a, b, goal
Step 2: เช็กว่าความยาวอิฐรวมทั้งหมด (a + b*5) มากกว่าหรือเท่ากับ goal หรือไม่
Step 3: หาเศษความยาวด้วย goal % 5 แล้วเช็กว่ามีอิฐเล็ก a พอสำหรับเศษนั้นหรือไม่
Step 4: ถ้าพอให้พิมพ์เศษนั้น ถ้าไม่พอหรือไม่ผ่านเช็กให้พิมพ์ -1
```
...
```text
คำนวณจำนวนอิฐใหญ่ที่ใช้ได้จริงโดย min(goal // 5, b)
แล้วนำความยาวที่เหลือ goal - (used_big * 5) มาเช็กว่ามีอิฐเล็ก a พอโปะหรือไม่
ถ้าพอให้พิมพ์จำนวนอิฐเล็กที่ต้องใช้ ถ้าไม่พอให้พิมพ์ -1
```
...
```text
เพราะว่ามีการรับเข้าที่พอดีในการสร้าง
```
...
```text
เพราะว่ามีการรับเข้าที่เกินความพอดีในการสร้าง
```
...
```text
เพราะว่ามีการรับเข้าที่ไม่พอดีในการสร้าง
```
