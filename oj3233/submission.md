...
```text
โจทย์ให้ตรวจผลสลากกินแบ่งที่มีหมวดตัวอักษรและเลข 5 หลัก โดยเปรียบเทียบสลากของฉันกับสลากรางวัลเพื่อคำนวณเงินรางวัลตามเงื่อนไขที่กำหนด เช่น ตรงทั้งหมด หรือถูกเลขท้าย 2-3 ตัว
```
...
```text
ผมวางแผนรับค่าสลากมาแยกหมวดและตัวเลข แล้วใช้ string slicing เช็กเลขท้าย 2 ตัวและ 3 ตัว จากนั้นใช้ if-elif เรียงลำดับตรวจสอบจากรางวัลใหญ่ที่สุดลงไปหารางวัลเล็กสุด
```
...
```text
เหมือนแผนแรก ผมสร้างตัวแปรเช็กตัวอักษรและเลขท้าย แล้วใช้ if-elif เรียงลำดับจากรางวัล 1,000,000 บาทลงไปจนถึง 0 บาท เพื่อพิมพ์มูลค่ารางวัลที่ได้
```
