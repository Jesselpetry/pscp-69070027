...
```text
โจทย์ให้รับข้อความ 1 บรรทัด แล้วนับจำนวนสระภาษาอังกฤษที่ปรากฏ โดยไม่สนใจว่าเป็นตัวพิมพ์เล็กหรือตัวพิมพ์ใหญ่ และแสดงสระที่นับได้

Input:
นับสระจากข้อความที่ให้มา โดยเป็น 
Output:
แสดงสระที่นับได้

Constraints:
ไม่สนใจตัวพิมพ์เล็กพิมพ์ใหญ่
```
...
```text
Step 1: อ่านข้อความ input แล้วแปลงเป็นตัวพิมพ์เล็กทั้งหมดด้วย .lower()
Step 2: ตั้งตัวแปรนับจำนวนสระ (a, e, i, o, u) แต่ละตัวเริ่มต้นเป็น 0 และสร้าง vowels = ['a', 'e', 'i', 'o', 'u']
Step 3: วนลูปตรวจสอบตัวอักษรทีละตัวในข้อความ ถ้าตรงกับสระตัวไหน ให้บวกเพิ่มตัวแปรนั้น +1
Step 4: เช็คเงื่อนไขทีละสระ หากสระตัวไหนมีจำนวนมากกว่า 0 ให้แสดงผล "สระ : จำนวน" ออกทางหน้าจอ

ตอนแรกวางแผนไว้ว่าจะเช็คทั้งพิมพ์ใหญ่และเล็ก แต่เพิ่งเห็นว่าไม่สนใจ case
```
