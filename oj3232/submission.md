...
```text
โจทย์ให้หาระยะกระโดดของกบ โดยครั้งแรกกระโดดได้ X เมตร และลดลงครั้งละ 2 เมตร หาจำนวนครั้งน้อยที่สุดที่ถึงระยะ Y เมตร ถ้ากระโดดจนหมดแรงแล้วยังไม่ถึงให้ตอบ -1
```
...
```text
ผมวางแผนใช้ while loop วนบวกระยะทางสะสมและนับจำนวนครั้ง พร้อมลดระยะกระโดดรอบละ 2 เมตร และหยุดเมื่อถึงเป้าหมายหรือระยะกระโดดหมด ถ้าไม่ถึงให้แสดง -1
```
...
```text
เหมือนแผนแรก ผมใช้ while distance > 0 and total < target วนบวก total และนับ jumps พร้อมลด distance ทีละ 2 เมื่อจบลูปถ้า total >= target ให้พิมพ์ jumps ถ้าไม่ใช่พิมพ์ -1
```
