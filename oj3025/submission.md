...
```text
โจทย์ให้ผมทำการเช็คเดือนและดูวันว่าวันนั้นคือ ฤดู อะไร

Input:
โปรแกรมรับจำนวนเต็ม (เดือน)
โปรแกรมรับจำนวนเต็ม (วัน)

Output:
โปรแรกมควรแสดงผล ฤดูการ นั้นๆออกมา

Constraints:
input
บรรทัดที่ 1 เดือน (จำนวนเต็ม)
บรรทัดที่ 2 วันที่ (จำนวนเต็ม)
output
บรรทัดที่ 1 ชื่อฤดูกาล (spring, summer, fall, winter)
```
...
Step 1: รับค่าเดือน
Step 2: รับค่าวัน
Step 3: ตรวจสอบเงื่อนไขตามแต่ละฤดูกาล
- winter:  เดือน 1, 2 OR (เดือน 12 วันที่ >= 21) OR (เดือน 3 วันที่ < 21)
- spring:  เดือน 4, 5 OR (เดือน 3 วันที่ >= 21) OR (เดือน 6 วันที่ < 21)
- summer:  เดือน 7, 8 OR (เดือน 6 วันที่ >= 21) OR (เดือน 9 วันที่ < 21)
- fall:    เดือน 10, 11 OR (เดือน 9 วันที่ >= 21) OR (เดือน 12 วันที่ < 21)
Step 4: พิมพ์ชื่อฤดูกาลตรงตามเงื่อนไขที่แมตช์ได้
```
...
```text
เพราะเป็นช่วงที่เช็คปกติ ยังไม่ใช่วันสุดท้ายของฤดู
```
...
```text
เพราะเป็นช่วงที่ต้องขึ้นฤดูการใหม่ได้แล้ว
```
