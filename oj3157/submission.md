...
```text
โจทย์ให้จำลองเกมสะสมแต้ม เริ่มต้นที่ 0 คะแนน จากนั้นอ่านคำสั่ง N ครั้ง ถ้าเจอเครื่องหมาย + ให้เพิ่ม 10 คะแนน ถ้าเจอเครื่องหมาย - ให้ลด 5 คะแนน แล้วแสดงคะแนนรวมสุดท้าย

Input:
บรรทัดแรกรับจำนวนเต็ม N แทนจำนวนรอบ จากนั้นรับคำสั่ง + หรือ - อีก N บรรทัด

Output:
แสดงคะแนนรวมสุดท้ายเป็นจำนวนเต็ม 1 ค่า

Constraints:
N อยู่ระหว่าง 1 ถึง 1000 และคำสั่งจะมีแค่เครื่องหมาย + กับ - เท่านั้น
```
...
```text
ใช้ for loop วนรอบตามจำนวน N แล้วใช้ input().strip() อ่านคำสั่งในแต่ละบรรทัด จากนั้นใช้ if-else เช็คเงื่อนไข ถ้าเจอ "+" จะบวกแต้มสะสมเพิ่ม 10 คะแนน นอกเหนือจากนั้นจะหักออก 5 คะแนน และแสดงผลลัพธ์สุดท้ายออกมา
```
