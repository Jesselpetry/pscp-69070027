...
```text
โจทย์ให้เช็คดูความต่างของคะแนนโหวตว่า gap มากกว่าหรือเท่ากับ 2 ไหม

Input:
2 บรรทัด
บรรทัดที่ 1: คะแนนรวมของทั้งสามคน(???)
บรรทัดที่ 2: คะแนนสูงสุดของทั้งสามคนนี้

Output:
1 บรรทัด
บรรทัดที่ 1: "Surprising" หรือ "Not surprising"

Constraints:
ไม่มีทางรู้คะแนนที่แน่นอนของทั้ง 3 คน
```
...
```text
Step 1: รับค่าคะแนนโหวตรวมทั้งหมด
Step 2: รับค่าคะแนนโหวตสูงสุด
Step 3: หาค่าคะแนนโหวตต่ำสุดที่เป็นไปได้ โดยการนำคะแนนสูงสุดมา *2 และลบด้วยคะแนนโหวตทั้งหมด
Step 4: เช็คว่าคะแนนโหวตต่ำสุดที่เป็นไปได้ = 0 หรือเปล่า
Step 5: นำคะแนนโหวตสูงสุด และ คะแนนโหวตต่ำสุดที่เป็นไปได้ มาลบกันและเช็คว่า มากกว่า 2 หรือไม่
Step 6: แสดงผล Surprising หรือ Not surprising
```
...
```text
เพราะมีค่าที่ค่อนข้างไม่ห่างกันมากหากนำมาหาค่าต่ำสุดที่เป็นไปได้
```
...
```text
เพราะมีค่าที่ค่อนข้างห่างกันมากหากนำมาหาค่าต่ำสุดที่เป็นไปได้
```
...
```text
เพราะมีค่าทเท่ากันทั้งหมดทั้ง 3 คนหากนำมาหาค่าต่ำสุดที่เป็นไปได้
```
