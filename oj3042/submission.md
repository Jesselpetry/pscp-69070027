...
```text
โจทย์ให้รับตัวเลข 1 จำนวน แล้วหาว่ามีเลขอะไรบ้างตั้งแต่เลขนั้นถอยหลังลงมาถึง 0 ที่หารด้วย 10 ได้ลงตัว

Input:
บรรทัดเดียว เป็นข้อมูลจำนวนเต็มบวก N

Output:
บรรทัดเดียว แสดงจำนวนเต็มบวกตั้งแต่ N ถึง 0 ที่หารด้วย 10 ลงตัว (คั่นข้อมูลแต่ละตัวด้วยช่องว่าง)

Constraints:
ต้องหารด้วย 10 ลงตัวก่อนถึงจะเริ่ม print ออกมาแบบถอยหลังได้
```
...
Step 2: เช็คเงื่อนไขการหารด้วย 10
Step 3: วนลูปเก็บตัวเลขลงลิสต์
Step 4: พิมพ์ตัวเลขในลิสต์ออกมา
```
...
```text
หาตัวเลขแรกที่หาร 10 ลงตัว: ใช้ n - (n % 10) เช่น 164 ให้กลายเป็น 160
คำนวณรอบและวนลูป: เอา num // 10 หาจำนวนรอบ แล้ววนลูปเก็บค่าลงลิสต์พร้อมลดค่าทีละ 10 ในแต่ละรอบ
แสดงผล: ใช้ print(*ans) เพื่อพิมพ์ตัวเลขทั้งหมดที่คั่นด้วยช่องว่าง
```
...
```text
เป็นค่าที่หาร 10 ไม่ลงตัวและต้องมีการปัดเศษ 81 -> 80
```
...
```text
เป็นค่าที่หาร 10 ไม่ลงตัวและต้องมีการปัดเศษ 136 -> 130
```
