...
```text
โจทย์ให้นำเข้าข้อความและทำการ reverse และ print ออกมาเป็นพิมพ์เล็กทั้งหมด

Input:
โปรแกรมรับข้อความ

Output:
โปรแกรมส่งข้อความออกมาเป็นแบบ Reverse และเป็นพิมพ์เล็ก

Constraints:
input รับข้อความตัวอักษรภาษาอังกฤษยาว 5 ตัวอักษร
output แสดงผลข้อความตัวอักษรภาษาอังกฤษแบบกลับด้านเป็นตัวพิมพ์เล็กเท่านั้น
```
...
```text
Step 1: เก็บข้อความ
Step 2: ทำการ print โดยใช้ [::-1].lower()
```
...
```text
เพราะมีทั้งพิมพ์ใหญ่พิมพ์เล็กและตัวเลข
```
...
```text
เพราะมีทั้งพิมพ์ใหญ่พิมพ์เล็กและตัวเลขและตัวอักษรพิเศษ
```
